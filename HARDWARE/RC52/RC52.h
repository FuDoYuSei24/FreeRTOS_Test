...
#define PICC_RESTORE          0xC2               //调块数据到缓冲
...
#define          RC522_Reset_Enable()      GPIO_ResetBits( GPIOF, GPIO_Pin_4 )
#define          RC522_Reset_Disable()     GPIO_SetBits ( GPIOF, GPIO_Pin_4 )

#define          RC522_SCK_0()             GPIO_ResetBits( GPIOF, GPIO_Pin_1 )
#define          RC522_SCK_1()             GPIO_SetBits ( GPIOF, GPIO_Pin_1 )

#define          RC522_MOSI_0()            GPIO_ResetBits( GPIOF, GPIO_Pin_2 )
#define          RC522_MOSI_1()            GPIO_SetBits ( GPIOF, GPIO_Pin_2 )
